...
#
# Test cases.
    print  sentiment('giulia',d)
    print sentiment('tears',d)
    print sentiment('right direction',d)
    print sentiment('right',d)
    print "absentee", sentiment("absentee",d)
    print "jim", sentiment("jim",d)
    #print d.items()
#
# Read tweet file
#
